...
public class SlateObject extends TuioObject implements ISlateObject {

	private Shape square;

	public SlateObject(TuioObject tobj)
	{
		super(tobj);
		int size = 60; //SlateComponent.object_size;
	...
	public void paint(Graphics2D g, int width, int height)
	{
		...
		float scale = height/(float)Slate.TABLE_SIZE;
